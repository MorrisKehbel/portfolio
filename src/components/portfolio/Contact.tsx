    ...
    <div className="h-full flex flex-col justify-evenly gap-2 ultra:gap-4">
      ...
      >
        ...
        <input
          ...
          className="p-4 rounded-lg h-10 ultra:h-13 bg-neutral/20 dark:bg-neutral/70 text-sm ultra:text-base focus:outline-none focus:ring focus:bg-neutral/15 dark:focus:bg-neutral/55 focus:ring-text/40 focus:[&::placeholder]:opacity-80 dark:focus:ring-text/20 text-text shadow-inner border border-white/30 dark:border-white/10 transition-all w-full placeholder-text/50"
        />
        ...
        <input
          ...
          className="p-4 rounded-lg h-10 ultra:h-13 bg-neutral/20 dark:bg-neutral/70 text-sm ultra:text-base focus:outline-none focus:ring focus:bg-neutral/15 dark:focus:bg-neutral/55 focus:ring-text/40 focus:[&::placeholder]:opacity-80 dark:focus:ring-text/20 text-text shadow-inner border border-white/30 dark:border-white/10 transition w-full placeholder-text/50"
        />
        ...
        <input
          ...
          className={`p-4 rounded-lg h-10 ultra:h-13 bg-neutral/20 dark:bg-neutral/70 text-sm ultra:text-base focus:outline-none focus:ring focus:bg-neutral/15 dark:focus:bg-neutral/55 focus:ring-text/40 focus:[&::placeholder]:opacity-80 dark:focus:ring-text/20 text-text shadow-inner transition w-full ${
        ...
        <button
          ...
          id="submit"
          name="submit"
          className="sm:col-span-2 bg-secondary/20  text-text rounded-lg p-2 ultra:p-3 hover:shadow-md hover:bg-neutral hover:text-primary dark:hover:text-text transition font-semibold w-full cursor-pointer select-none"
