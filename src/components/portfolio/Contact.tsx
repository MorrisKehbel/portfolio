    ...
    <div className="h-full flex flex-col justify-evenly gap-2 ultra:gap-4">
      ...
      >
        ...
        <input
          ...
          className="p-4 rounded-lg h-10 ultra:h-13 bg-neutral/20 dark:bg-neutral/70 text-sm ultra:text-base focus:outline-none focus:ring focus:bg-neutral/15 dark:focus:bg-neutral/55 focus:ring-text/40 focus:placeholder-text/40 dark:focus:ring-text/20 text-text shadow-inner border border-white/30 dark:border-white/10 transition-all w-full placeholder-text/50"
        />
        ...
        <input
          ...
          className="p-4 rounded-lg h-10 ultra:h-13 bg-neutral/20 dark:bg-neutral/70 text-sm ultra:text-base focus:outline-none focus:ring focus:bg-neutral/15 dark:focus:bg-neutral/55 focus:ring-text/40 focus:placeholder-text/40 dark:focus:ring-text/20 text-text shadow-inner border border-white/30 dark:border-white/10 transition w-full placeholder-text/50"
        />
        ...
        <input
          ...
          className={`p-4 rounded-lg h-10 ultra:h-13 bg-neutral/20 dark:bg-neutral/70 text-sm ultra:text-base focus:outline-none focus:ring focus:bg-neutral/15 dark:focus:bg-neutral/55 focus:ring-text/40 focus:placeholder-text/40 dark:focus:ring-text/20 text-text shadow-inner transition w-full ${
